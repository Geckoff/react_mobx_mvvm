...
import { ProductionLineViewController } from "./ProductionLineViewController";
import { useInstance } from "../../hooks/useInstance";

export const ProductionLine = inject("carsStore")(
	observer(({ productionLineViewModel }) => {
		const {
			carsBatchesOrders,
			chassisAssembly,
			bodyAssembly,
			...
			moveToPainting,
			sellCarsBatch
		} = useInstance(new ProductionLineViewController(productionLineViewModel));
